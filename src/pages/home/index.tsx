  ...
  return (
    <Layout className="layout">
      ...
      <Layout className="sider">
        <Content style={{ marginBottom: "32px" }}>
          {topLikedStream ? (
            <div className="top-liked-container">
              ...
              />
              <div className="top-liked-banner">Top likes</div>
        ...
        <Content>
          <Title level={4} className="title-center">Featured Streams</Title>
          <Row gutter={[16, 16]}>
            {streams.length > 0 ? (
                  ...
                  <Card
                    ...
                    cover={
                      <div style={{ position: "relative" }}>
                        ...
                        />
                        <span className="view-count">{stream.currentViewCount} watching</span>
