...
export default function Category() {
  ...
  return (
    ...
    <Sider width={240} className="sider">
      ...
      <Content>
          <h2 className="title-center"><span style={{borderBottom: "4px solid rgba(145, 71, 255, 1)"}}>{category?.toLocaleUpperCase()} STREAMS</span></h2>
          <Row gutter={[16, 16]}>
            {streams.length > 0 ? (
          ...
          {!streams || streams.length==0 && <div className="center"><h2>No streams available</h2></div>}
          <Pagination
            align="center"
